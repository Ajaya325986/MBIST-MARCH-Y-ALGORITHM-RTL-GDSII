...
# Generated on: Wed Nov 27 12:34:24 IST 2024 (Wed Nov 27 07:04:24 UTC 2024)
...
set logfile fv/controller1/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/controller1 -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  controller1.v
elaborate_design -golden -root {controller1} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/controller1/fv_map.v.gz
elaborate_design -revised -root {controller1}
...
#add_name_alias fv/controller1/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.controller1.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.controller1.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.controller1.rtl.fv_map.rpt
